    ...
    <div class="page-flex">
        ...
        <div class="main-wrapper">
            ...
            <main class="main users chart-page" id="skip-target">
                <div class="container">
                    <h2 class="main-title">Data Balita</h2>
                    <a href="dataBalitaTambah.php" class="primary-default-btn">Tambah Data Balita</a>
                    <br><br>
                    <div class="users-table table-wrapper">
                        <table id="dataBalita" class="posts-table">
                            <thead>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= hitungUmur($balita['tanggal_lahir']) ?></td>
                                        <td><?= $dataIbu['nama'] ?></td>
                                        <td>
                                            <a href="dataBalitaEdit.php?id=<?= $balita['id'] ?>" class="primary-default-btn">Sunting</a>
                                            <br>
                                            <a href="dataBalitaHapus.php?id=<?= $balita['id'] ?>" onclick="return confirm('Konfirmasi hapus data?')" class="primary-default-btn" style="background-color: red;">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                }
