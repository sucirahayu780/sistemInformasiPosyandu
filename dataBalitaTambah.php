...
if (isset($_POST['TAMBAHDATABALITA'])) {
    $result = tambahDataBalita($_POST);
    if ($result == 200) {
        echo "<script>alert('Berhasil menambahkan data balita!'); window.location.href = 'dataBalita.php';</script>";
    } else {
        echo "<script>alert('Gagal menambahkan data balita! Terjadi kesalahan.'); window.location.href = 'dataBalitaTambah.php';</script>";
    }
}
    ...
    <div class="page-flex">
        ...
        <div class="main-wrapper">
            ...
            <main class="main users chart-page" id="skip-target">
                <div class="container">
                    <h2 class="main-title">Tambah Data Balita</h2>
                            ...
                            <label class="form-label-wrapper">
                                ...
                                <select name="ibu_id" class="form-input" required>
                                    <?php foreach ($dataIbu as $ibu) { ?>
                                        <option value="<?= $ibu['id'] ?>"><?= $ibu['nik'] ?> - <?= $ibu['nama'] ?></option>
                                    <?php } ?>
                                </select>
                            </label>

                            <br>
                            <button type="submit" name="TAMBAHDATABALITA" class="form-btn primary-default-btn transparent-btn">Tambah Data Balita</button>
                        </form>
                    </article>
                </div>
            </main>
