    ...
    <div class="page-flex">
        ...
        <div class="main-wrapper">
            ...
            <main class="main users chart-page" id="skip-target">
                <div class="container">
                    <h2 class="main-title">Data Ibu</h2>
                    <a href="dataIbuTambah.php" class="primary-default-btn">Tambah Data Ibu</a>
                    <br><br>
                    <div class="users-table table-wrapper">
                        <table id="dataIbu" class="posts-table">
                            <thead>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $ibu['telp'] ?></td>
                                        <td>
                                            <a href="dataIbuEdit.php?id=<?= $ibu['id'] ?>" class="primary-default-btn">Sunting</a>
                                            <br>
                                            <a href="dataIbuHapus.php?id=<?= $ibu['id'] ?>" onclick="return confirm('Konfirmasi hapus data?')" class="primary-default-btn" style="background-color: red;">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                }
