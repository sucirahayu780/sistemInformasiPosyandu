...
if (isset($_POST['TAMBAHDATAIBU'])) {
    $result = tambahDataIbu($_POST);
    if ($result == 200) {
        echo "<script>alert('Berhasil menambahkan data ibu!'); window.location.href = 'dataIbu.php';</script>";
    } else {
        echo "<script>alert('Gagal menambahkan data ibu! NIK sudah terdaftar.'); window.location.href = 'dataIbuTambah.php';</script>";
    }
}
                    ...
                    <article class="sign-up">
                        <form class="sign-up-form form" action="" method="post">
                            <label class="form-label-wrapper">
                                ...
                                <input class="form-input" type="number" name="nik" autocomplete="off" required>
                            </label>
                            <label class="form-label-wrapper">
                                <p class="form-label">Nama</p>
                                <input class="form-input" type="text" name="nama" autocomplete="off" required>
                            </label>
                            <label class="form-label-wrapper">
                                <p class="form-label">Tempat Lahir</p>
                                <input class="form-input" type="text" name="tempat_lahir" autocomplete="off" required>
                            </label>
                            <label class="form-label-wrapper">
                            ...
                            <label class="form-label-wrapper">
                                ...
                                <textarea class="form-input" name="alamat" required></textarea>
                            </label>
                            <label class="form-label-wrapper">
                            ...
                            <label class="form-label-wrapper">
                                ...
                                <input class="form-input" type="text" name="suami" autocomplete="off" required>
                            </label>
                            <label class="form-label-wrapper">
                                <p class="form-label">Nomor Handphone</p>
                                <input class="form-input" type="number" name="telp" autocomplete="off" required>
                            </label>
                            <br>
                            <button type="submit" name="TAMBAHDATAIBU" class="form-btn primary-default-btn transparent-btn">Tambah Data Ibu</button>
                        </form>
                    </article>
                </div>
            </main>
