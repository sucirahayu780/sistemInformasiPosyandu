...
if (isset($_POST['TAMBAHDATAJENISIMUNISASI'])) {
    $result = tambahDataJenisImunisasi($_POST);
    if ($result == 200) {
        echo "<script>alert('Berhasil menambahkan data jenis imunisasi!'); window.location.href = 'dataJenisImunisasi.php';</script>";
    } else {
        echo "<script>alert('Gagal menambahkan data jenis imunisasi! Terjadi kesalahan.'); window.location.href = 'dataJenisImunisasiTambah.php';</script>";
    }
}
    ...
    <div class="page-flex">
        ...
        <div class="main-wrapper">
            ...
            <main class="main users chart-page" id="skip-target">
                <div class="container">
                    <h2 class="main-title">Tambah Data Jenis Imunisasi</h2>
                    ...
                    <article class="sign-up">
                        <form class="sign-up-form form" action="" method="post">
                            ...
                            <br>
                            <button type="submit" name="TAMBAHDATAJENISIMUNISASI" class="form-btn primary-default-btn transparent-btn">Tambah Data Jenis Imunisasi</button>
                        </form>
                    </article>
                </div>
            </main>
