    ...
    <div class="page-flex">
        ...
        <div class="main-wrapper">
            ...
            <main class="main users chart-page" id="skip-target">
                <div class="container">
                    <h2 class="main-title">Data Penimbangan Balita</h2>
                    <a href="penimbanganBalitaTambah.php" class="primary-default-btn">Tambah Data Penimbangan Balita</a>
                    <br><br>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="penimbanganBalitaHapus.php?id=<?= $penimbangan['id'] ?>" onclick="return confirm('Konfirmasi hapus data?')" class="primary-default-btn" style="background-color: red;">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                }
